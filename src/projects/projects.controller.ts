import { Body, Controller, Delete, Post, Get, Param, NotFoundException } from '@nestjs/common';
...
export class ProjectsController {
  ...
  async getByName(@Param('name') name: string) {
      ...
      return { name: project.name, apiKey: project.apiKey, cloudinaryConfig: project.cloudinaryConfig };
  }
  @Get(':apiKey')
